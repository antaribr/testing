  ...
  container.innerHTML = `
    <div>
      ...
      <div style="margin-bottom: 16px; box-sizing: border-box;">
        ...
        <!-- BANNER PROFILE CARD (RTL alignment: Avatar RIGHT, Name & Unit RIGHT) -->
        ...
        <!-- DETAILS CARD SECTION (Clean English Labels) -->
        ...
        <!-- BADGES CARD SECTION (Clean English Title) -->
...
'''
    ...
    with open(filePathApp, 'w', encoding='utf-8') as f:
        f.write(appCode)
    print('Successfully restored clean English labels in app.js!')
else:
