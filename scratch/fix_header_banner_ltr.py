...
# 1. Update downloadMemberProfilePdf
  ...
  container.innerHTML = `
    <div>
      ...
      <div style="margin-bottom: 16px; box-sizing: border-box;">
        ...
        <!-- TOP HEADER BRANDING (Logo LEFT, Date RIGHT - 2nd picture match) -->
        ...
        <!-- BANNER PROFILE CARD (Avatar LEFT, Name & Unit LEFT - 2nd picture match) -->
...
'''
    ...
    with open(filePathApp, 'w', encoding='utf-8') as f:
        f.write(appCode)
    print('Updated downloadMemberProfilePdf header and profile banner to match 2nd picture!')
else:
