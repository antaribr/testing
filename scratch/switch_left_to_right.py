  ...
  container.innerHTML = `
    <div>
      ...
      <div style="margin-bottom: 16px; box-sizing: border-box;">
        ...
        <!-- TOP HEADER BRANDING (Date LEFT, Logo RIGHT) -->
        ...
        <!-- BANNER PROFILE CARD (Avatar RIGHT, Name & Unit RIGHT - RTL) -->
        <div class="pdf-section-card" style="background:#eef2ff; border-radius:10px; padding:12px 16px; display:flex; align-items:center; justify-content:flex-end; gap:14px; margin-bottom: 14px;" dir="rtl">
...
'''
    ...
    with open(filePathApp, 'w', encoding='utf-8') as f:
        f.write(appCode)
    print('Successfully switched Header and Profile Banner from Left to Right!')
else:
