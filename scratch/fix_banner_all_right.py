  ...
  container.innerHTML = `
    <div>
      ...
      <div style="margin-bottom: 16px; box-sizing: border-box;">
        ...
        <!-- BANNER PROFILE CARD (All elements Avatar + Name + Unit aligned on RIGHT) -->
...
'''
    ...
    with open(filePathApp, 'w', encoding='utf-8') as f:
        f.write(appCode)
    print('Successfully fixed Profile Banner alignment: Avatar, Name, and Unit Chip all aligned on the RIGHT!')
else:
